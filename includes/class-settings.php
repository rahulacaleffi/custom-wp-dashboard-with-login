...
class Custom_Dashboard_Settings
{
    ...
    {
        add_menu_page(
            __('Custom WP Dashboard - Settings', 'custom-wp-dashboard-w-login'),
            __('WP Dashboard', 'custom-wp-dashboard-w-login'),
            'manage_options',
            'custom-dashboard-settings',
    ...
    public function register_settings()
    {
        ...
        add_settings_section(
            ...
            __('General Settings', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'logo_url',
            __('Dashboard Logo URL', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'login_logo_url',
            __('Login Logo URL', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            ...
            __('Login Background Image', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'website_url',
            __('Website URL', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_section(
            ...
            __('Color Settings', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'primary_color',
            __('Primary Color', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'secondary_color',
            __('Secondary Color', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_section(
            ...
            __('Support Settings', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'enable_support_link',
            __('Enable Support Link', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'support_link_url',
            __('Support Link URL', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'support_link_text',
            __('Support Link Text', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_section(
            ...
            __('Copyright Settings', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'copyright_text',
            __('Copyright Text', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'enable_debug_mode',
            __('Enable Debug Mode', 'custom-wp-dashboard-w-login'),
        ...
        add_settings_field(
            'disable_gutenberg',
            __('Disable Gutenberg Editor', 'custom-wp-dashboard-w-login'),
    ...
    public function general_section_callback()
    {
        echo '<p class="section-description">' .
            esc_html__('Configure the general appearance settings of your dashboard, including logos and website URL. These settings affect both the admin dashboard and login page.', 'custom-wp-dashboard-w-login') .
            '</p>';
    }
    ...
    {
        echo '<p class="section-description">' .
            esc_html__('Add a support link to your admin bar for quick access to help resources. Enable this if you want to provide easy access to support for your users.', 'custom-wp-dashboard-w-login') .
            '</p>';
    }
    ...
    {
        echo '<p class="section-description">' .
            esc_html__('Set your copyright text that appears in the dashboard footer. Use {year} as a placeholder to automatically display the current year.', 'custom-wp-dashboard-w-login') .
            '</p>';
    }
    ...
    {
        echo '<p class="section-description">' .
            esc_html__('Customize the color scheme of your dashboard and login page. The primary color is used for main elements and backgrounds, while the secondary color is used for accents and highlights.', 'custom-wp-dashboard-w-login') .
            '</p>';
    }
    ...
    public function primary_color_callback()
    {
        ...
        echo '<p class="description">' . esc_html__('Primary color used throughout the dashboard and login page. Consider text as "white" and the selected color as background (menus, texts and the login page)', 'custom-wp-dashboard-w-login') . '</p>';
    }
    ...
    public function secondary_color_callback()
    {
        ...
        echo '<p class="description">' . esc_html__('Secondary color used throughout the dashboard.', 'custom-wp-dashboard-w-login') . '</p>';
    }
...
?>
        <div class="custom-dashboard-logo-upload">
            ...
            <button type="button"
                ...
                <?php esc_html_e('Upload/Select Image', 'custom-wp-dashboard-w-login'); ?>
            </button>
            <?php if ($value): ?>
                <div class="custom-dashboard-image-preview">
                    <img src="<?php echo esc_url($value); ?>" alt="<?php esc_attr_e('Dashboard Logo Preview', 'custom-wp-dashboard-w-login'); ?>" />
                    <a href="#" class="custom-dashboard-remove-image" data-target="logo_url">
                        <?php esc_html_e('Remove image', 'custom-wp-dashboard-w-login'); ?>
                    </a>
                </div>
            <?php endif; ?>
            <p class="description"><?php esc_html_e('Upload or enter the URL to the logo image for the dashboard.', 'custom-wp-dashboard-w-login'); ?></p>
        </div>
    <?php
    }
    ...
    ?>
        <div class="custom-dashboard-logo-upload">
            ...
            <?php if ($value): ?>
                <div class="custom-dashboard-image-preview">
                    <img src="<?php echo esc_url($value); ?>" alt="<?php esc_attr_e('Login Logo Preview', 'custom-wp-dashboard-w-login'); ?>" />
                    <a href="#" class="custom-dashboard-remove-image" data-target="login_logo_url">
                        <?php esc_html_e('Remove image', 'custom-wp-dashboard-w-login'); ?>
                    </a>
                </div>
            <?php endif; ?>
            <p class="description"><?php esc_html_e('Upload or enter the URL to the logo image for the login page.', 'custom-wp-dashboard-w-login'); ?></p>
        </div>
    <?php
    }
    ...
    public function website_url_callback()
    {
        ...
        echo '<p class="description">' . esc_html__('URL to your website. Defaults to site URL.', 'custom-wp-dashboard-w-login') . '</p>';
    }
    ...
    ?>
        <div class="custom-dashboard-logo-upload">
            ...
            <?php if ($value): ?>
                <div class="custom-dashboard-image-preview">
                    <img src="<?php echo esc_url($value); ?>" alt="<?php esc_attr_e('Login Background Preview', 'custom-wp-dashboard-w-login'); ?>" />
                    <a href="#" class="custom-dashboard-remove-image" data-target="login_background_url">
                        <?php esc_html_e('Remove image', 'custom-wp-dashboard-w-login'); ?>
                    </a>
                </div>
            <?php endif; ?>
            <p class="description"><?php esc_html_e('Upload or enter the URL to the background image for the login page.', 'custom-wp-dashboard-w-login'); ?></p>
        </div>
    <?php
    }
    ...
    public function enable_support_link_callback()
    {
        ...
        echo ' ' . esc_html__('Show support link in admin bar', 'custom-wp-dashboard-w-login') . '</label>';
    }
    ...
    public function support_link_url_callback()
    {
        ...
        echo '<p class="description">' . esc_html__('URL for the support link (e.g., your support page or contact form).', 'custom-wp-dashboard-w-login') . '</p>';
    }

    public function support_link_text_callback()
    {
        $options = get_option('custom_dashboard_options');
        $value = isset($options['support_link_text']) ? $options['support_link_text'] : __('Support', 'custom-wp-dashboard-w-login');
        echo '<input type="text" name="custom_dashboard_options[support_link_text]" value="' . esc_attr($value) . '" class="regular-text" />';
        echo '<p class="description">' . esc_html__('Text to display for the support link.', 'custom-wp-dashboard-w-login') . '</p>';
    }
    ...
    public function copyright_text_callback()
    {
        ...
        echo '<p class="description">' . esc_html__('Copyright text to display in footer. Use {year} as placeholder for current year.', 'custom-wp-dashboard-w-login') . '</p>';
    }
    ...
    public function enable_debug_mode_callback()
    {
        ...
        echo ' ' . esc_html__('Enable debug mode for troubleshooting.', 'custom-wp-dashboard-w-login') . '<br/><i>Enable/disable caching css</i></label>';
    }
    ...
    public function disable_gutenberg_callback()
    {
        ...
        echo ' ' . esc_html__('Disable the Gutenberg block editor and use the classic editor instead.', 'custom-wp-dashboard-w-login') . '</label>';
    }
    ...
    public function render_settings_page()
    {
        if (!current_user_can('manage_options')) {
            wp_die(
                esc_html__('Sorry, you do not have sufficient permissions to access this page.', 'custom-wp-dashboard-w-login')
            );
        }
        ...
        if (
            ...
            wp_die(
                esc_html__('Invalid nonce verification', 'custom-wp-dashboard-w-login')
            );
        }
    ...
    ?>
        <div class="wrap custom-dashboard-settings">
            ...
            <form action="options.php" method="post">
                ...
                submit_button(__('Save Settings', 'custom-wp-dashboard-w-login'));
                ?>
            </form>
        </div>
<?php
